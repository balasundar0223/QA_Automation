...
await adminHome.loadAndLogin("CUSTOMERADMIN");
  ...
  await createCourse.catalogSearch("Org "+FakerData.getTagNames()+(Date.now()));
...
test.only(`Verify the admin able to delete the child organization`, async ({ adminHome, organization, CompletionCertification,contentHome,createCourse }) => 
    {
     test.info().annotations.push(
           { type: `Author`, description: `Vidya` },
