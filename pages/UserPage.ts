...
<<<<<<< HEAD
    ...
    async typeAndSelectIUser(data:string){
        ...
        await this.validateElementVisibility(this.selectors.customerAdminUserFromDropdown(data), "dropdown")
        await this.click(this.selectors.customerAdminUserFromDropdown(data), "admin","dropdown");
...
async editUser(){
    ...
    //     async getAddress(label: string, id:string) {
    //     const selector = this.page.locator(this.selectors.addressInput(label,id)).inputValue();
    //     return selector;
    ...
    // async uncheckInheritFrom(){
    //     await this.click(this.selectors.uncheckInheritFromCheckbox,"unhecek","checkbox")
    // }
