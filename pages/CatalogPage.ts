...
<<<<<<< HEAD
    async selectresultantTags(tagName: string) {
        ...
        //  await this.wait('minWait');
        await this.mouseHover(this.selectors.resultantTagname(tagName), "Tags")
        await this.validateElementVisibility(this.selectors.resultantTagname(tagName), "Tags")
        await this.click(this.selectors.resultantTagname(tagName), "Tags", "selected")
    }
    async clickApply() {
